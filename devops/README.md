...
DEPLOY_ENV=prod
DEPLOY_HOST=tremt-carloshcl.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for tremt-carloshcl.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    tremt-carloshcl.tangrama.com.br:
      ansible_user: root
      host: tremt-carloshcl
      hostname: tremt-carloshcl.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/tremt-carloshcl.tangrama.com.br.yml` to the remote server with:
